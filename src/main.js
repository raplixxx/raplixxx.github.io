    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="color: var(--text-secondary); margin-bottom: 12px;">Pilih grup tujuan:</p>
                ${snapshot.docs.map(doc => {
                    const group = doc.data();
                    return `
                        <div class="chat-item" style="cursor: pointer;" onclick="forwardMessage(${JSON.stringify(messageData).replace(/"/g, '&quot;')}, '${doc.id}'); this.closest('.modal').remove();">
                            <div class="chat-item-avatar">${group.name.charAt(0)}</div>
...
// INIT
// ==========================================
console.log('✅ Semua modul loaded');
console.log('📋 Fitur aktif:');
console.log('  - Login Google ✅');
console.log('  - Chat Private ✅');
console.log('  - Chat Grup ✅');
console.log('  - AI Assistant (@bot) ✅');
console.log('  - Voice Note ✅');
console.log('  - Status 24 Jam ✅');
console.log('  - Dark Mode Otomatis ✅');
console.log('  - Link Acak User ✅');
console.log('  - Notifikasi ✅');
console.log('  - Emoji ✅');
console.log('  - Reply & Forward ✅');
console.log('  - Edit Pesan ✅');
console.log('  - Reaksi Emoji ✅');
console.log('================================');
console.log('🎉 RaflyChat siap digunakan!');
